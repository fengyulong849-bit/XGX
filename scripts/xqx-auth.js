(function () {
  ...
  window.XQXAuth = {
    ...
    async deleteAccount(currentPassword) { return callAuthenticated("account-delete", { current_password: currentPassword, confirmation: "注销", request_id: uuid() }); },
    ...
    async manageModerator(targetId, action, requestId) { return callAuthenticated("moderation-role", { target_id: targetId, action, request_id: requestId || crypto.randomUUID() }); },
